...
Stitch AI를 활용하여 화면을 설계하였고, 실제 UI는 코드 베이스로 직접 구현하였습니다. <br>
...
- v1.0.1 (2026.03.01 ~ 2026.03.02: 2일)
  - Delegate 순환 참조로 인한 Memory Leak 방지를 위해 delegate 참조를 `weak`으로 변경
- v1.0.0 (2025.11.16 ~ 2026.01.06: 52일)
  - Todolune 최초 출시
  - 할일 CRUD 기능 구현
  - Core Data 기반 데이터 영속성 처리
